...
from app.api.v1.endpoints import auth, dashboard, green, health, knowledge, projects, quality, reports, safety, users, work_orders, worker_care
...
for endpoint in (health, auth, users, projects, dashboard, safety, work_orders, worker_care, reports, knowledge, quality, green):
