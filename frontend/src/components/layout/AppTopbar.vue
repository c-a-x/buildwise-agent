...
<template>
  <header class="topbar">
    <div class="topbar-left"><button class="icon-button" type="button" :aria-label="app.mobileNavOpen ? '关闭导航' : '打开导航'" @click="app.toggleSidebar"><AppIcon name="menu" :size="18" /></button><div><p class="breadcrumb">BuildWise / {{ pageTitle }}</p><strong>{{ pageTitle }}</strong></div></div>
