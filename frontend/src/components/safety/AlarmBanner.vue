...
<style scoped>
.alarm-banner { display: flex; align-items: center; flex-wrap: wrap; gap: 12px; border: 1px solid var(--line); border-radius: 12px; padding: 10px 14px; background: var(--surface); transition: border-color var(--ease), background var(--ease); }
.alarm-banner.active { border-color: var(--danger); background: var(--danger-bg); }
...
.violation-chip { border-radius: 999px; padding: 2px 9px; color: var(--danger); background: var(--surface); border: 1px solid var(--danger); font-size: 10px; font-weight: 800; }
@keyframes bell-ring {
...
.ctl-btn { display: inline-flex; align-items: center; gap: 5px; min-height: 44px; border: 1px solid var(--line); border-radius: 8px; padding: 0 10px; color: var(--text-soft); background: var(--surface); font-size: 11px; font-weight: 800; cursor: pointer; transition: border-color var(--ease), color var(--ease), background var(--ease); }
.ctl-btn:hover { border-color: var(--blue); color: var(--blue); }
.ctl-btn.on { border-color: var(--primary); color: var(--surface); background: var(--primary); }
</style>
