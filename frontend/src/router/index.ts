...
const protectedRoutes: RouteRecordRaw[] = [
  ...
  { path: '/projects', name: 'projects', component: () => import('@/views/projects/ProjectListView.vue'), meta: { requiresAuth: true, title: '项目管理', roles: ['admin', 'project_manager'] } },
  ...
  { path: '/worker-care', name: 'worker-care', component: () => import('@/views/worker-care/WorkerCareView.vue'), meta: { requiresAuth: true, title: '工友助手', roles: ['admin', 'project_manager', 'safety_officer', 'worker'] } },
  { path: '/worker-wellbeing', name: 'worker-wellbeing', component: () => import('@/views/wellbeing/WellbeingView.vue'), meta: { requiresAuth: true, title: '工友关怀', roles: ['admin', 'project_manager', 'safety_officer', 'worker'] } },
  ...
  { path: '/quality', name: 'quality', component: () => import('@/views/quality/QualityInspectionView.vue'), meta: { requiresAuth: true, title: '质量巡检', roles: ['admin', 'project_manager', 'quality_inspector'] } },
  { path: '/green', name: 'green', component: () => import('@/views/green/GreenConstructionView.vue'), meta: { requiresAuth: true, title: '绿色建造', roles: ['admin', 'project_manager', 'safety_officer'] } },
